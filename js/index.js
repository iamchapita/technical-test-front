...
function loadProfileList(archive) {
	...
	for (var i = 0; i < archive.length; i++) {
		...
		dropdown.innerHTML +=
			...
			image +
			"'class='profilePicture'><a class='dropdown-item' href='#'>" +
			name +
			"<br>" +
			email +
			"</a></li></div>";
	...
	dropdown.innerHTML +=
		"<div class='profileList'><li class='option'> <span class='material-symbols-outlined' id='personAdd'>person_add</span> <a class='dropdown-item' href='#'>Agregar Instructor</a></li></div>";

	dropdown.innerHTML +=
		"<div class='profileList'><li class='option'><a class='dropdown-item'>Privacy Police • Terms of Service</a></li></div>";
}

function loadCourses(archive) {
